            ...
            <div class="checkout-tabs">
                <div class="row">
                    ...
                    <div class="col-xl-10 col-sm-9">
                                            ...
                                            <div>
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline mr-4">
                                                    ...
                                                    <label class="custom-control-label" for="customRadioInline2"><i
                                                            class="fab fa-cc-paypal mr-1 font-size-20 align-top"></i>
                                                        Paypal</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline mr-4">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-centered mb-0 table-nowrap">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th scope="row"><img
                                                                        src="{{asset('assets/dashboard/images/product/img-7.png')}}"
                                                                        alt="product-img" title="product-img"
                                                                        class="avatar-md"></th>
                                                                <td>
                                                                    <h5 class="font-size-14 text-truncate"><a
                                                                ...
                                                                <td colspan="3">
                                                                    <div class="bg-soft-primary p-3 rounded">
                                                                        <h5 class="font-size-14 text-primary mb-0">
                                                                            ...
                                                                            Shipping <span class="float-right">Free</span>
                                                                        </h5>
                                                                    </div>
                                                                </td>
                                                            </tr>
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-6">
                                <a href="{{route('cart')}}" class="btn text-muted d-none d-sm-inline-block btn-link">
