                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('update-profile', Auth::user()->id) }}">
                                ...
                                <div class="row mb-3">
                                    <label for="phoneNumber" class="col-md-4 col-form-label text-md-end">Phone
                                        number</label>

                                    <div class="col-md-6">
                                        <input id="phoneNumber" type="number"
                                            class="form-control @error('phoneNumber') is-invalid @enderror"
                                            name="phoneNumber" value="{{ Auth::user()->phone_number }}" required
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="password-confirm" type="password" class="form-control"
                                            name="password_confirmation" autocomplete="new-password" value="">
                                    </div>
                                </div>
