                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="{{url('/')}}"n>Men's</a></li>
                            <li class="scroll-to-section"><a href="{{url('/')}}">Wome's</a></li>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{url('/contact')}}">Contact Usssss</a></li>
                                </ul>
                            </li>
                            <li class="submenu">
                                <a href="javascript:;">Features</a>
                                <ul>
                                    <li><a href="#">Features Page 11</a></li>
                                    <li><a href="#">Features Page 21</a></li>
                                    <li><a href="#">Features Page 31</a></li>
