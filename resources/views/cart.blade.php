                            ...
                            <div class="table-responsive">
                                <table class="table table-centered mb-0 table-nowrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/dashboard/images/product/img-1.png') }}"
                                                    alt="product-img" title="product-img" class="avatar-md" />
                                            </td>
                                            <td>
                                                <h5 class="font-size-14 text-truncate"><a
                                                        href="ecommerce-product-detail.html" class="text-dark">Half sleeve
                                                        T-shirt</a></h5>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/dashboard/images/product/img-2.png') }}"
                                                    alt="product-img" title="product-img" class="avatar-md" />
                                            </td>
                                            <td>
                                                <h5 class="font-size-14 text-truncate"><a
                                                        href="ecommerce-product-detail.html" class="text-dark">Light blue
                                                        T-shirt</a></h5>
                                                <p class="mb-0">Color : <span class="font-weight-medium">Light
                                                        blue</span></p>
                                            </td>
                                            <td>
                                                $ 225
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/dashboard/images/product/img-3.png') }}"
                                                    alt="product-img" title="product-img" class="avatar-md" />
                                            </td>
                                            <td>
                                                <h5 class="font-size-14 text-truncate"><a
                                                        href="ecommerce-product-detail.html" class="text-dark">Black Color
                                                        T-shirt</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="font-size-14 text-truncate"><a
                                                        href="ecommerce-product-detail.html" class="text-dark">Hoodie
                                                        (Blue)</a></h5>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/dashboard/images/product/img-5.png') }}"
                                                    alt="product-img" title="product-img" class="avatar-md" />
                                            </td>
                                            <td>
                                                <h5 class="font-size-14 text-truncate"><a
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/dashboard/images/product/img-6.png') }}"
                                                    alt="product-img" title="product-img" class="avatar-md" />
                                            </td>
                                            <td>
                                                <h5 class="font-size-14 text-truncate"><a
                                                        href="ecommerce-product-detail.html" class="text-dark">Green color
                                                        T-shirt</a></h5>
                                                <p class="mb-0">Color : <span class="font-weight-medium">Green</span>
                                                </p>
                                            </td>
                                            <td>
                                                $ 152
